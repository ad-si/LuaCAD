...
function TestSphere:testSphereCreationWithRadius()
  ...
  if file then
    ...
    file:close()
    luaunit.assertStrContains(content, "sphere", "Sphere command not found in generated SCAD file")
    luaunit.assertStrContains(content, "r = 5", "Radius parameter not found in generated SCAD file")
  end
end
...
function TestSphere:testSphereCreationWithDiameter()
  ...
  luaunit.assertNotNil(file, "SCAD file for sphere with diameter was not created")
  if file then
    local content = file:read("*all")
    file:close()
    luaunit.assertStrContains(content, "sphere", "Sphere command not found in generated SCAD file")
    luaunit.assertStrContains(content, "d = 10", "Diameter parameter not found in generated SCAD file")
  end
end
...
function TestSphere:testSphereTranslation()
  ...
  if file then
    ...
    file:close()
    luaunit.assertStrContains(content, "sphere", "Sphere command not found in generated SCAD file")
    luaunit.assertStrContains(content, "translate", "Translate command not found in generated SCAD file")
    luaunit.assertStrContains(content, "[10,10,10]", "Translate coordinates not found in generated SCAD file")
  end
end
