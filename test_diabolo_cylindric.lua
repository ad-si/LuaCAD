...
function TestDiaboloCylindric:testDiaboloCreation()
  ...
  -- Create the model
  local cylinder = (cad.cylinder(0,0,0, h/2, self.radius_bottom, self.radius_middle)
    - cad.cylinder(0,0,0, h/2, self.radius_bottom-self.thickness, self.radius_middle-self.thickness))
    + (cad.cylinder(0,0,h/2, h/2, self.radius_middle, self.radius_bottom)
    - cad.cylinder(0,0,h/2, h/2, self.radius_middle-self.thickness, self.radius_bottom-self.thickness))
...
function TestDiaboloCylindric:testCustomParameters()
  ...
  local cylinder = (cad.cylinder(0,0,0, h/2, rb, rm)
